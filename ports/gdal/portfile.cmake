...
if (NOT VCPKG_CMAKE_SYSTEM_NAME OR VCPKG_CMAKE_SYSTEM_NAME STREQUAL "WindowsStore")
  ...
  # Setup zlib libraries + include path
  file(TO_NATIVE_PATH "${CURRENT_INSTALLED_DIR}/include" ZSTD_INCLUDE_DIR)
  ...
  file(TO_NATIVE_PATH "${CURRENT_INSTALLED_DIR}/lib/libssl.lib" OPENSSL_LIBRARY_REL)
  file(TO_NATIVE_PATH "${CURRENT_INSTALLED_DIR}/lib/libcrypto.lib" LIBEAY_LIBRARY_REL)

  file(TO_NATIVE_PATH "${CURRENT_INSTALLED_DIR}/debug/lib/libssl.lib" OPENSSL_LIBRARY_DBG)
  file(TO_NATIVE_PATH "${CURRENT_INSTALLED_DIR}/debug/lib/libcrypto.lib" LIBEAY_LIBRARY_DBG)
  ...
  list(APPEND NMAKE_OPTIONS
	  ...
	  CRYPTOPP_INC=-I${CRYPTOPP_INCLUDE_DIR}
  ...
  list(APPEND NMAKE_OPTIONS_REL
      ...
      CRYPTOPP_LIB=${CRYPTOPP_LIBRARY_REL}
      "OPENSSL_LIB=${OPENSSL_LIBRARY_REL} ${LIBEAY_LIBRARY_REL}"
      ...
      ZSTD_LIBS=${ZSTD_LIBRARY_REL}
      "PG_LIB=${PGSQL_LIBRARY_REL} Secur32.lib Shell32.lib Advapi32.lib Crypt32.lib Gdi32.lib ${OPENSSL_LIB}"
  )
  ...
  list(APPEND NMAKE_OPTIONS_DBG
      ...
      CRYPTOPP_LIB=${CRYPTOPP_LIBRARY_DBG}
      "OPENSSL_LIB=${OPENSSL_LIBRARY_DBG} ${LIBEAY_LIBRARY_DBG} crypt32.lib"
      ...
      ZSTD_LIBS=${ZSTD_LIBRARY_DBG}
      "PG_LIB=${PGSQL_LIBRARY_DBG} Secur32.lib Shell32.lib Advapi32.lib Crypt32.lib Gdi32.lib ${OPENSSL_LIB}"
      DEBUG=1
  )
